...
async function playTrailer (movieId){
    ...
    try {
        ...
        if (response.ok) {
            window.location.href = data.trailerUrl;
        } else {
            alert("Oops! Trailer Not Available.")
...
function buildMoviesSection(list, categoryName){
    ...
    const moviesListHTML = list.map(item => {
        return `
        <div class="movie-item" onclick="playTrailer(${item.id})">
